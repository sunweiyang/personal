...
plugins=(django git python virtualenv)
...
alias gom='cd ~/Skale/Repos/skale-mobile/'
alias gos='cd ~/Skale/Repos/skale-website/'
alias gow='cd ~/Skale/Repos/skale-web/'
alias gohq='cd ~/Skale/Repos/skale-hq/'
alias gob='cd ~/Skale/Repos/skale-backend/; source $WORKON_HOME/skale/bin/activate; export SKALE_APP_VERSION=1.19.1 CODEPUSH_VERSION=370 UA_PARSER_YAML=regexes.yaml'
alias skalex='open ~/Skale/Repos/skale-mobile/ios/Skale.xcworkspace/'
